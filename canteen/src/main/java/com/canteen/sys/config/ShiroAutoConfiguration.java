...
import com.canteen.sys.realm.FacultyRealm;
import lombok.Data;
...
public class ShiroAutoConfiguration {
     ...
     */
    @Bean("facultyRealm")
    public FacultyRealm facultyRealm(CredentialsMatcher credentialsMatcher) {
        FacultyRealm facultyRealm = new FacultyRealm();
        // 注入凭证匹配器
        facultyRealm.setCredentialsMatcher(credentialsMatcher);
        return facultyRealm;
    }
    ...
    public SecurityManager securityManager(FacultyRealm facultyRealm) {
